...
```
user: what structures does testModpack add, and does anything override vanilla?

1. packwiz-structures testModpack
...
2. Drill into the vanilla overrides: packwiz-structures testModpack
