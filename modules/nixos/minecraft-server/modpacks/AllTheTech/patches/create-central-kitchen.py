#!/usr/bin/env python3
"""Demote Create: Central Kitchen's hard dep on create_dragons_plus.

Usage: create-central-kitchen.py <META-INF/neoforge.mods.toml>
...
compat; with the dep demoted to optional the mod loads normally and just skips
those recipes.
...
#     [[dependencies."create_central_kitchen"]]
...
if n == 0:
    ...
    if n2 != 1:
        sys.stderr.write(
            ...
            "re-review upstream metadata (Create: Central Kitchen)\n"
        )
        sys.exit(1)
    new = new2
