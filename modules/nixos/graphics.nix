  ...
  config = lib.mkMerge [
    ...
    (lib.mkIf nvidia.CUDABinaryCache {
      nix.settings = {
        ...
        trusted-public-keys = [
          "cache.nixos.org-1:6NCHdD59X431o0gWypbMrAURkbJ16ZPMQFGspcDShjY= cuda-maintainers.cachix.org-1:0dqXKq+exampleReplaceThisKey= cuda-maintainers.cachix.org-1:0dq3bujKpuEPMCX6U4WylrUDZ9JyUG0VpVZa7CNfq5E="
        ];
      };
    })
    # -- GPU: AMD ----------------------------------------------------
