{
  name = "opencode";
  description = "OpenCode AI coding agent with support for 15+ LLM providers, 15 custom skills, 6 custom tools, 8 custom commands, 7 custom agents, and MCP integration.";
  category = "programs";
